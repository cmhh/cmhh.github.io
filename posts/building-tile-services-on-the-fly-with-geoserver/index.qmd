...
date: "2019-09-17"
archives: "2019"
categories: ["geospatial", "R", "GeoServer"]
tags: ["geospatial", "R", "GeoServer"]
description: "Sending large vector features over-the-wire for use in slippy maps is bad, m'kay.  One possible solution is to appeal to a tile service or similar, and here we look at how we might leverage the GeoServer API to enable end-users to quickly deploy their own tile sets on-the-fly."
image: assets/geoserver.webp
---
...
![](assets/leaflet003.png)

![](assets/leaflet004.png)
...
![](assets/leaflet005.png)

![](assets/leaflet006.png)
